...
public class AddEmployeeSteps extends CommonMethods {
	...
	public void i_see_Employee_has_been_succesfully_added() {
		...
		Assert.assertEquals("Employee is NOT being "
				+ "added", pdetails.empId.getText(), empId);
	}
	...
	public void modifyEmployeeDetails(DataTable modifyEmpDetail) throws InterruptedException {
		...
		public void i_add_firstName_middleName_and_last_name() {
		    AddEmployeePageElements addem = new AddEmployeePageElements();
		    sendText(addem.firstName,"Abdil");
		    sendText(addem.middleName,"Abd");
		    sendText(addem.lastName, "Karakoc");
		}
